...
local BundleConfig = {
    UI = {
        ...
        ["Panel_Register"] = { ["UILayer"] = "Normal",
                            ["AssetPath"] = "Prefab/UI/LoginScene/Panel_Register",
                            ["CodePath"] = "ApplicationLayer/UI/LoginScene/Panel_Register", },
        ["Panel_Tips"] = { ["UILayer"] = "Tips",
                               ["AssetPath"] = "Prefab/UI/Common/Panel_Tips",
                               ["CodePath"] = "ApplicationLayer/UI/Common/Panel_Tips", },
