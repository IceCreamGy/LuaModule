...
--local Panel_Shop_ClassifySelectButton = Class("Panel_Shop_ClassifySelectButton", BaseUI)
...
function Panel_Shop_ClassifySelectButton:Select()
    ...
    --弹出关联面板
    UIManager.OpenPoPupUIWithParent(self.data.TargetModel, self. PutPos, nil)
    --记录关联面板
