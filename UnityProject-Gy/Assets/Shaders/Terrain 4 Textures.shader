Shader "TopCar/Env/Terrain 4 Textures" {
Properties {
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Albedo.rgb = (lay1 * splat_control.r / total + lay2 * splat_control.g / total + lay3 * splat_control.b / total + lay4 * splat_control.a / total)/* * _ColorBrightness*/;
}
ENDCG 
}
// Fallback to Diffuse
