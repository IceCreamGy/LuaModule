Shader "TopCar/Env/WaterDefaultFog" {
Properties {
    ...
    SubShader 
    {
		...
		pass
		{
			...
			{		
                ...
                half4 backColor = finalColor;
                UNITY_APPLY_FOG(IN.fogCoord, finalColor); // apply fog
                finalColor = lerp(backColor, finalColor, _FogFactor);
				return finalColor;
			}
		ENDCG
		}
