...
Shader "QF/Env/Basic_Scroll2Layers-Sine-AlphaBlend" {
Properties {
	...
	_DiffuseColorMax ("DiffuseColorAlpha(rgb为白色时，diffuse为纯色贴图，a为黑色时，diffuse有透明属性)", Color) = (0,0,0,1)
	//_AlphaPower ("AlphaPower", Range(0.0, 1.0)) = 1
}
...
//		#pragma fragmentoption ARB_precision_hint_fastest		
		fixed4 frag (v2f i) : COLOR
		{
			...
			//o.rgb = tex.rgb * tex2.rgb * i.color.rgb;
			//fixed3 col = (1,1,1);
			o.rgb = tex.rgb * tex2.rgb + _DiffuseColorMax.rgb;
			
			o.rgb = saturate(o.rgb) * i.color.rgb;
			
			
			
			fixed alpha = tex.r * tex2.r + _DiffuseColorMax.a;
			o.a = saturate(alpha) * i.color.a;
			//o = tex * tex2 * i.color;
