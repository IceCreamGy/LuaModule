...
Shader "Hidden/TopCar/FX/TransparentCommon_0" {
	Properties {
		...
		_fadeStrength("Fade Strength", Float) = 2.0
		...
		_DisolveKeepColor("DisolveKeepColor",Float) = 0.0
...
//			#pragma multi_compile _ ENABLE_BLACK_EDGE_FADE_AND_INNER_COLOR
			...
			//#endif	
				...
				diffuseCol *= max(_DisolveKeepColor , (1.0 - dislove));
				alpha -= dislove;
