Shader "TopCar/Mirrors/Bumped Specular Alpha Mask" {
Properties {
	...
	SubShader
	{
		...
		//{
			...
			void surf(Input IN, inout SurfaceOutput o) {
				...
				fixed4 cDistWeight = tex2D(_MaskTex, IN.uv_MaskTex);
				o.Albedo = lerp(tex.rgb * _Color.rgb * _BlendLevel, ref.rgb * _RefColor.rgb * _RefRate, cDistWeight.r);

				//o.Emission = lerp(ref.rgb * _RefColor.rgb * _RefRate, fixed(0, 0, 0, 1), cDistWeight.r);
