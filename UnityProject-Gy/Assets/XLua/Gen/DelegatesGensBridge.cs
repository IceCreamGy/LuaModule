...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp16(int p0, byte[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(float p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.GameObject>(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(System.Action<UnityEngine.GameObject, XLua.LuaTable, UnityEngine.CanvasGroup>))
			{
			    return new System.Action<UnityEngine.GameObject, XLua.LuaTable, UnityEngine.CanvasGroup>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Action<int, byte[]>))
			{
			    return new System.Action<int, byte[]>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Action<float>))
			{
			    return new System.Action<float>(__Gen_Delegate_Imp17);
			}
