...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class AntialiasingEditor : Editor
    {
        ...
        private SerializedProperty ssaaShader;
        private SerializedProperty dlaaShader;
        ...
        private void OnEnable()
        {
            ...
            ssaaShader = serObj.FindProperty("ssaaShader");
            dlaaShader = serObj.FindProperty("dlaaShader");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            else if (mode.enumValueIndex == (int) AAMode.DLAA)
            {
                ...
                EditorGUILayout.PropertyField(dlaaShader, new GUIContent("dlaaShader"));
            }
            else if(mode.enumValueIndex == (int) AAMode.SSAA)
            {
                EditorGUILayout.PropertyField(ssaaShader, new GUIContent("ssaaShader"));
            }
