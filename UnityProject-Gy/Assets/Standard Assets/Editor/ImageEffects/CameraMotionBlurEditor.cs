...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class CameraMotionBlurEditor : Editor
    {
        ...
        SerializedProperty maxVelocitySide;
        ...
        SerializedProperty blurMaskTexture;
        //SerializedProperty maskBlurShader;
        ...
        void OnEnable () {
            ...
            maxVelocitySide = serObj.FindProperty("maxVelocitySide");
            ...
            blurMaskTexture = serObj.FindProperty("blurMaskTexture");
            //maskBlurShader = serObj.FindProperty("maskBlurShader");
        }
        ...
        public override void OnInspectorGUI () {
            ...
            if (filterType.enumValueIndex >= 2) {
                ...
                EditorGUILayout.Slider(maxVelocitySide, 2.0f, 20.0f, new GUIContent(" Velocity Max Side"));
            }
            else
                EditorGUILayout.Slider (maxVelocity, 2.0f, 10.0f, new GUIContent(" Velocity Max"));
            ...
            if (filterType.enumValueIndex == 0) {
                ...
                if(filterType.enumValueIndex == 2)
                {
                    EditorGUILayout.PropertyField(blurMaskTexture, new GUIContent(" Camera Blur Mask"));
                    //EditorGUILayout.PropertyField(maskBlurShader, new GUIContent(" Camera Blur Mask shader"));
                }
            }
