...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class Tonemapping : PostEffectsBase
    {
        public enum TonemapperType
        {
            ...
            AdaptiveReinhardAutoWhiteScale,
        };
        ...
        public float autoWhiteScale = 5.0f;
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            if (type == TonemapperType.AdaptiveReinhardAutoWhite || type == TonemapperType.AdaptiveReinhardAutoWhiteScale)
            {
            ...
            else if (type == TonemapperType.AdaptiveReinhardAutoWhiteScale)
            {
                tonemapMaterial.SetFloat("_AvgWhiteScale", autoWhiteScale);
